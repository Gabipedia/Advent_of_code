...
def solve_part1(input_list, dial_value=START_DIAL_VALUE):
    zeros_counter = 0
...
def solve_part2(input_list, dial_value=START_DIAL_VALUE):
    zeros_counter = 0
    for rotation in input_list:
...
if __name__ == "__main__":
    print(f"Result day 1 - part1: {solve_part1(parse_input(INPUT_FILE))}")
    print(f"Result day 1 - part2: {solve_part2(parse_input(INPUT_FILE))}")
